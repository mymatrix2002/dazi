...
function runTypingFullMode(text){
    ...
    if (window.virtualKeyboard && window.virtualKeyboard.isEnabled()) {
        ...
        if (fullLines.length > 0 && fullLines[0].length > 0) {
            window.virtualKeyboard.updateHighlight(fullLines[0][0]);
        }
    }
}
...
function runTypingBilingualMode(text){
    ...
    if (window.virtualKeyboard && window.virtualKeyboard.isEnabled()) {
        window.virtualKeyboard.reset();
        if (pairs.length > 0 && pairs[0].en.length > 0) {
            window.virtualKeyboard.updateHighlight(pairs[0].en[0]);
        }
    }
}